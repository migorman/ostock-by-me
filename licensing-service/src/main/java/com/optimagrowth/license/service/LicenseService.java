...
public class LicenseService {
	...
	@RateLimiter(name = "organizationService", fallbackMethod = "buildFallbackOrganization")
	@Retry(name = "retryOrganizationService", fallbackMethod = "buildFallbackOrganization")
	@Bulkhead(name = "bulkheadOrganizationService", type= Type.THREADPOOL, fallbackMethod = "buildFallbackOrganization")
	private Organization getOrganization(String organizationId) {
		return organizationRestClient.getOrganization(organizationId);
	}
	
	@SuppressWarnings("unused")
	private Organization buildFallbackOrganization(Throwable t){
			Organization organization = new Organization();
			organization.setId("000-000-0000");
			organization.setName(
			"Sorry no organization information currently available");
			return organization;
	}
...
//	@Bulkhead(name = "bulkheadLicenseService", type= Type.THREADPOOL, fallbackMethod = "buildFallbackLicenseList")
	public List<License> getLicensesByOrganization(String organizationId) throws TimeoutException, InterruptedException {
