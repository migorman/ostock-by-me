...
public class OrganizationRestTemplateClient {
	...
	public Organization getOrganization(String organizationId) {
		logger.debug("In Licensing Service.getOrganization: {}", new UserContext().getCorrelationId());
		...
		ResponseEntity<Organization> restExchange = keycloakRestTemplate.exchange(
				...
				"http://localhost:8072/organization/v1/organization/{organizationId}", HttpMethod.GET, null,
